...
public class JApps extends JFrame {
	 ...
	 */
	public JApps() {
		setTitle("XTA JMETER - AIDT QRE AUTOMATION");
		...
		JLabel lblJavaApplicationWorld = new JLabel("AIDT QRE AUTOMATION - release 2.6.0");
		lblJavaApplicationWorld.setFont(new Font("Tahoma", Font.PLAIN, 21));
		
		JButton button = new JButton("");
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				LookAndFeelDemo.main(new String[]{});
			}
		});
